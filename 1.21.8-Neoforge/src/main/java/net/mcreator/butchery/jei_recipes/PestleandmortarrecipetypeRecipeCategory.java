...
public class PestleandmortarrecipetypeRecipeCategory implements IRecipeCategory<PestleandmortarrecipetypeRecipe> {
	public final static ResourceLocation UID = ResourceLocation.parse("butchery:pestleandmortarrecipetype");
	public final static ResourceLocation TEXTURE = ResourceLocation.parse("butchery:textures/screens/jei_pestleandmortar_copy.png");
	...
	@Override
	public IRecipeType<PestleandmortarrecipetypeRecipe> getRecipeType() {
	...
	@Override
	public void draw(PestleandmortarrecipetypeRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
	...
	public void setRecipe(IRecipeLayoutBuilder builder, PestleandmortarrecipetypeRecipe recipe, IFocusGroup focuses) {
		...
		builder.addSlot(RecipeIngredientRole.INPUT, 5, 17).add(recipe.getIngredients().get(0));
		builder.addSlot(RecipeIngredientRole.OUTPUT, 77, 17).add(actualOutputs.get(0));
	}
}