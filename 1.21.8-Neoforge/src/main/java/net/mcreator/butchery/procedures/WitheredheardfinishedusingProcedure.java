...
public class WitheredheardfinishedusingProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (entity.getPersistentData().getBooleanOr("hasBlessing", false) == false) {
			entity.getPersistentData().putBoolean("hasBlessing", true);
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
				_entity.addEffect(new MobEffectInstance(ButcheryModMobEffects.WITHEREDHEARTEFFECT, 6000, 1, false, false));
