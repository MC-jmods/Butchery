		...
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == ButcheryModBlocks.SKIN_RACK.get()
			...
			if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == ButcheryModItems.SALT.get()
				...
				if ((entity instanceof ServerPlayer _plr14 && _plr14.level() instanceof ServerLevel _serverLevel14
						&& _plr14.getAdvancements().getOrStartProgress(_serverLevel14.getServer().getAdvancements().get(ResourceLocation.parse("butchery:step_toward_leather"))).isDone()) == true) {
					if ((entity instanceof ServerPlayer _plr15 && _plr15.level() instanceof ServerLevel _serverLevel15
							&& _plr15.getAdvancements().getOrStartProgress(_serverLevel15.getServer().getAdvancements().get(ResourceLocation.parse("butchery:seasonedtoperfection"))).isDone()) == false) {
						if (entity instanceof ServerPlayer _player && _player.level() instanceof ServerLevel _level) {
							AdvancementHolder _adv = _level.getServer().getAdvancements().get(ResourceLocation.parse("butchery:seasonedtoperfection"));
							if (_adv != null) {
