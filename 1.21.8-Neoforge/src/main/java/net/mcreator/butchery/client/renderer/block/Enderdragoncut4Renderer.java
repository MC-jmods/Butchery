...
public class Enderdragoncut4Renderer implements BlockEntityRenderer<Enderdragoncut4BlockEntity> {
	...
	@Override
	public void render(Enderdragoncut4BlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource renderer, int light, int overlayLight, Vec3 cameraPos) {
