...
public class VindicatorarmorArmor {
	@SubscribeEvent
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
					...
					armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("head",
									new ModelPart(Collections.emptyList(),
											Map.of("head", new Modelvindicator_disguise(Minecraft.getInstance().getEntityModels().bakeLayer(Modelvindicator_disguise.LAYER_LOCATION)).Head, "hat",
		...
		event.registerItem(new IClientItemExtensions() {
			...
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
				if (armorModel == null) {
					Modelvindicator_disguise model = new Modelvindicator_disguise(Minecraft.getInstance().getEntityModels().bakeLayer(Modelvindicator_disguise.LAYER_LOCATION));
					armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
