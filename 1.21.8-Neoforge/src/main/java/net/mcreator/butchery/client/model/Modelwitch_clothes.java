...
public class Modelwitch_clothes extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("butchery", "modelwitch_clothes"), "main");
	...
	public Modelwitch_clothes(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hat4_r1 = Head.addOrReplaceChild("hat4_r1", CubeListBuilder.create().texOffs(0, 95).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.25F)),
				PartPose.offsetAndRotation(0.3F, -16.2656F, 1.9329F, -0.6109F, 0.0F, 0.0F));
		PartDefinition hat3_r1 = Head.addOrReplaceChild("hat3_r1", CubeListBuilder.create().texOffs(0, 87).addBox(-1.875F, -4.0F, -1.75F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.175F, -11.85F, 0.15F, -0.2618F, 0.0F, 0.0F));
		PartDefinition hat2_r1 = Head.addOrReplaceChild("hat2_r1", CubeListBuilder.create().texOffs(0, 76).addBox(-3.5F, -2.0F, -3.5F, 7.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.25F, -10.2794F, 0.3266F, -0.1575F, -0.0038F, -0.0003F));
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(18, 22).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(2, 40).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 20.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(37, 44).addBox(-4.0F, -2.0F, -2.5F, 5.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 2.0F, 0.0F));
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(37, 44).addBox(-1.0F, -2.0F, -2.5F, 5.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(5.0F, 2.0F, 0.0F));
