...
public class CashregisterblockRenderer implements BlockEntityRenderer<CashregisterblockBlockEntity> {
	...
	private void updateRenderState(CashregisterblockBlockEntity blockEntity, float partialTick) {
	...
	@Override
	public void render(CashregisterblockBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource renderer, int light, int overlayLight, Vec3 cameraPos) {
	...
	private static final class CustomHierarchicalModel extends Modelcash_register {
		...
		public CustomHierarchicalModel(ModelPart root) {
			super(root);
			this.keyframeAnimation0 = registercloseAnimation.close.bake(root);
			this.keyframeAnimation1 = registeropenAnimation.open.bake(root);
		}

		public void setupBlockEntityAnim(CashregisterblockBlockEntity blockEntity, LivingEntityRenderState state) {
