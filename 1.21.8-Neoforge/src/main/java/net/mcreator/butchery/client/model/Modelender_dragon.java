...
public class Modelender_dragon extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("butchery", "modelender_dragon"), "main");
	...
	public Modelender_dragon(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition neck2 = neck1.addOrReplaceChild("neck2",
				CubeListBuilder.create().texOffs(192, 104).addBox(-5.0F, -5.0F, -5.0F, 10.0F, 10.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(48, 0).addBox(-1.0F, -9.0F, -3.0F, 2.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, -10.0F, 0.0F, -0.1309F, 0.0F));
		...
		PartDefinition neck5 = neck4.addOrReplaceChild("neck5",
				CubeListBuilder.create().texOffs(192, 104).addBox(-5.0F, -5.0F, -5.0F, 10.0F, 10.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(48, 0).addBox(-1.0F, -9.0F, -3.0F, 2.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, -10.0F, 0.0F, -0.1745F, 0.0F));
		PartDefinition head = neck5.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(176, 44).addBox(-8.0F, 1.625F, -30.25F, 12.0F, 5.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(112, 30).addBox(-10.0F, -5.375F, -16.25F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(1.0F, -9.375F, -10.25F, 2.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(112, 0).addBox(1.0F, -0.375F, -28.25F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, -3.625F, -3.75F, 0.0F, -0.3491F, 0.0F));
		PartDefinition mirrored = head.addOrReplaceChild("mirrored", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-5.0F, -90.0F, -28.0F, 2.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(112, 0).mirror()
				.addBox(-5.0F, -81.0F, -46.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-2.0F, 80.625F, 17.75F));
		PartDefinition jaw = head.addOrReplaceChild("jaw", CubeListBuilder.create().texOffs(176, 65).addBox(-6.0F, -72.0F, -16.0F, 12.0F, 4.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, 78.625F, -14.25F));
