...
@EventBusSubscriber
public class HorsedarkbrowndropProcedure {
	@SubscribeEvent
				...
				if (ButcheryconfigConfiguration.HORSE_CARCASS.get() == true) {
					if (ButcheryconfigConfiguration.SPECIFIC_TOOLS.get() == true) {
						if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).is(ItemTags.create(ResourceLocation.parse("forge:cleaver")))
							...
							if (horseEntity.getVariant().toString().contains("DARK_BROWN") && horseEntity.getMarkings().toString().contains("NONE")) {
								if (!world.isClientSide() && world.getServer() != null) {
									for (ItemStack itemstackiterator : world.getServer().reloadableRegistries().getLootTable(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.parse("butchery:blocks/regular_dark_brown_carcass_loot")))
							...
							} else if (horseEntity.getVariant().toString().contains("DARK_BROWN") && horseEntity.getMarkings().toString().contains("WHITE") && !horseEntity.getMarkings().toString().contains("WHITE_DOTS")
							...
							} else if (horseEntity.getVariant().toString().contains("DARK_BROWN") && horseEntity.getMarkings().toString().contains("WHITE_FIELD")) {
								if (!world.isClientSide() && world.getServer() != null) {
									for (ItemStack itemstackiterator : world.getServer().reloadableRegistries().getLootTable(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.parse("butchery:blocks/regular_dark_brown_carcass_loot")))
											.getRandomItems(new LootParams.Builder((ServerLevel) world).create(LootContextParamSets.EMPTY))) {
										if (world instanceof ServerLevel _level) {
							...
							} else if (horseEntity.getVariant().toString().contains("DARK_BROWN") && horseEntity.getMarkings().toString().contains("WHITE_DOTS")) {
								if (!world.isClientSide() && world.getServer() != null) {
									for (ItemStack itemstackiterator : world.getServer().reloadableRegistries().getLootTable(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.parse("butchery:blocks/regular_dark_brown_carcass_loot")))
											.getRandomItems(new LootParams.Builder((ServerLevel) world).create(LootContextParamSets.EMPTY))) {
										if (world instanceof ServerLevel _level) {
							...
							} else if (horseEntity.getVariant().toString().contains("DARK_BROWN") && horseEntity.getMarkings().toString().contains("BLACK_DOTS")) {
								if (!world.isClientSide() && world.getServer() != null) {
									for (ItemStack itemstackiterator : world.getServer().reloadableRegistries().getLootTable(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.parse("butchery:blocks/regular_dark_brown_carcass_loot")))
											.getRandomItems(new LootParams.Builder((ServerLevel) world).create(LootContextParamSets.EMPTY))) {
										if (world instanceof ServerLevel _level) {
