...
public class WaterbottlehintOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (WaterhintoverlayProcedure.execute(world, entity)) {
			event.getGuiGraphics().blit(RenderType::guiTextured, ResourceLocation.parse("butchery:textures/screens/sponge_overlay.png"), w / 2 + -479, h / 2 + -267, 0, 0, 960, 540, 960, 540);
