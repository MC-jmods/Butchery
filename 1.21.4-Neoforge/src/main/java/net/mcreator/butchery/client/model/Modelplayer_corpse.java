...
public class Modelplayer_corpse extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("butchery", "modelplayer_corpse"), "main");
	...
	public Modelplayer_corpse(ModelPart root) {
		super(root);
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				...
				PartPose.offsetAndRotation(0.0F, 4.15F, -0.225F, 0.7069F, 0.0F, 0.0F));
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				...
				PartPose.offsetAndRotation(0.0F, 4.15F, -0.225F, 0.1091F, 0.0F, 0.0F));
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				...
				PartPose.offsetAndRotation(-5.0F, 6.15F, -0.225F, 0.0262F, 0.0F, 0.0F));
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				...
				PartPose.offset(5.0F, 6.15F, -0.225F));
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				...
				PartPose.offsetAndRotation(-1.9F, 15.85F, 1.075F, -0.0436F, 0.0F, 0.0436F));
