 ...
 * @author Author
 */
public class elder_guardian_cut_1Animation {
	public static final AnimationDefinition tail_removed = AnimationDefinition.Builder.withLength(2.0F).looping()
			.addAnimation("bone",
			...
			.addAnimation("tail1", new AnimationChannel(AnimationChannel.Targets.POSITION, new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, -23.0F), AnimationChannel.Interpolations.LINEAR)))
			.addAnimation("tail2", new AnimationChannel(AnimationChannel.Targets.POSITION, new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, -43.0F), AnimationChannel.Interpolations.LINEAR)))
