...
public class Modelhanging_enderman extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("butchery", "modelhanging_enderman"), "main");
	...
	public Modelhanging_enderman(ModelPart root) {
		super(root);
