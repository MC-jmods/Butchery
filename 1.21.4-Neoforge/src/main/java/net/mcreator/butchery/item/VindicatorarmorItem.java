...
public abstract class VindicatorarmorItem extends ArmorItem {
			...
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
				return new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("head",
						new ModelPart(Collections.emptyList(),
								Map.of("head", new Modelvindicator_disguise(Minecraft.getInstance().getEntityModels().bakeLayer(Modelvindicator_disguise.LAYER_LOCATION)).Head, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()))),
		...
		event.registerItem(new IClientItemExtensions() {
			...
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
				return new HumanoidModel(new ModelPart(Collections.emptyList(),
						Map.of("body", new Modelvindicator_disguise(Minecraft.getInstance().getEntityModels().bakeLayer(Modelvindicator_disguise.LAYER_LOCATION)).Body, "left_arm",
								new Modelvindicator_disguise(Minecraft.getInstance().getEntityModels().bakeLayer(Modelvindicator_disguise.LAYER_LOCATION)).LeftArm, "right_arm",
								new Modelvindicator_disguise(Minecraft.getInstance().getEntityModels().bakeLayer(Modelvindicator_disguise.LAYER_LOCATION)).RightArm, "head",
			...
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
				return new HumanoidModel(new ModelPart(Collections.emptyList(),
						Map.of("left_leg", new Modelvindicator_disguise(Minecraft.getInstance().getEntityModels().bakeLayer(Modelvindicator_disguise.LAYER_LOCATION)).LeftLeg, "right_leg",
								new Modelvindicator_disguise(Minecraft.getInstance().getEntityModels().bakeLayer(Modelvindicator_disguise.LAYER_LOCATION)).RightLeg, "head",
	...
	private VindicatorarmorItem(ArmorType type, Item.Properties properties) {
