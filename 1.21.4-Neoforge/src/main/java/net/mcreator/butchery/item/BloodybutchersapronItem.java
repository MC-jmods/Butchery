...
public abstract class BloodybutchersapronItem extends ArmorItem {
		...
		event.registerItem(new IClientItemExtensions() {
			...
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
				return new HumanoidModel(new ModelPart(Collections.emptyList(),
						Map.of("body", new Modelbloody_butcher_apron(Minecraft.getInstance().getEntityModels().bakeLayer(Modelbloody_butcher_apron.LAYER_LOCATION)).Body, "left_arm",
								new Modelbloody_butcher_apron(Minecraft.getInstance().getEntityModels().bakeLayer(Modelbloody_butcher_apron.LAYER_LOCATION)).LeftArm, "right_arm",
								new Modelbloody_butcher_apron(Minecraft.getInstance().getEntityModels().bakeLayer(Modelbloody_butcher_apron.LAYER_LOCATION)).RightArm, "head",
	...
	private BloodybutchersapronItem(ArmorType type, Item.Properties properties) {
