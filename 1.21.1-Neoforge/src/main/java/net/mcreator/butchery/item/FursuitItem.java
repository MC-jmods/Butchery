...
public abstract class FursuitItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 9, BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), () -> Ingredient.of(new ItemStack(ButcheryModItems.WOLF_PELT.get())), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("butchery:evoker_robes"))), 0f, 0f);
			registerHelper.register(ResourceLocation.parse("butchery:fur_suit"), armorMaterial);
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		event.registerItem(new IClientItemExtensions() {
			...
			public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
				HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
						Map.of("head", new Modelwolf_fur_suit(Minecraft.getInstance().getEntityModels().bakeLayer(Modelwolf_fur_suit.LAYER_LOCATION)).Head, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "body",
		...
		event.registerItem(new IClientItemExtensions() {
			...
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
				HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("body", new Modelwolf_fur_suit(Minecraft.getInstance().getEntityModels().bakeLayer(Modelwolf_fur_suit.LAYER_LOCATION)).Body, "left_arm",
						...
						new Modelwolf_fur_suit(Minecraft.getInstance().getEntityModels().bakeLayer(Modelwolf_fur_suit.LAYER_LOCATION)).RightArm, "head", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "hat",
			...
			public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
				HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
						Map.of("left_leg", new Modelwolf_fur_suit(Minecraft.getInstance().getEntityModels().bakeLayer(Modelwolf_fur_suit.LAYER_LOCATION)).LeftLeg, "right_leg",
								new Modelwolf_fur_suit(Minecraft.getInstance().getEntityModels().bakeLayer(Modelwolf_fur_suit.LAYER_LOCATION)).RightLeg, "head", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "hat",
			...
			public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
				HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
						Map.of("left_leg", new Modelwolf_fur_suit(Minecraft.getInstance().getEntityModels().bakeLayer(Modelwolf_fur_suit.LAYER_LOCATION)).LeftBoot, "right_leg",
								new Modelwolf_fur_suit(Minecraft.getInstance().getEntityModels().bakeLayer(Modelwolf_fur_suit.LAYER_LOCATION)).RightBoot, "head", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "hat",
								new ModelPart(Collections.emptyList(), Collections.emptyMap()), "body", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "right_arm", new ModelPart(Collections.emptyList(), Collections.emptyMap()),
								"left_arm", new ModelPart(Collections.emptyList(), Collections.emptyMap()))));
				armorModel.crouching = living.isShiftKeyDown();
				armorModel.riding = defaultModel.riding;
	...
	public FursuitItem(ArmorItem.Type type, Item.Properties properties) {
