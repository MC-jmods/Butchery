									...
									: -1) == 1) {
						{
							if (world instanceof ILevelExtension extension) {
								...
								if (fluidHandler != null) {
									fluidHandler.fill(new FluidStack((new FluidStack(BuiltInRegistries.FLUID.get(ResourceLocation.parse("bloodmagic:life_essence_fluid")), 1)).getFluid(), (int) 50), IFluidHandler.FluidAction.EXECUTE);
								}
							}
						}
					} else if ((world.getBlockState(BlockPos.containing(x, y - 2, z))).getBlock() == ButcheryModBlocks.BLOOD_GRATE.get()
					...
					if ((world.getBlockState(BlockPos.containing(x, y - 1, z))).getBlock() == ButcheryModBlocks.BLOOD_GRATE.get()
									...
									: -1) == 2) {
						{
							if (world instanceof ILevelExtension extension) {
								IFluidHandler fluidHandler = extension.getCapability(Capabilities.FluidHandler.BLOCK, BlockPos.containing(x, (y - 1), z), null);
								if (fluidHandler != null) {
									fluidHandler.fill(new FluidStack((new FluidStack(BuiltInRegistries.FLUID.get(ResourceLocation.parse("hexerei:blood_fluid")), 1)).getFluid(), (int) 50), IFluidHandler.FluidAction.EXECUTE);
								}
							}
						}
					} else if ((world.getBlockState(BlockPos.containing(x, y - 2, z))).getBlock() == ButcheryModBlocks.BLOOD_GRATE.get()
					...
					if ((world.getBlockState(BlockPos.containing(x, y - 1, z))).getBlock() == ButcheryModBlocks.BLOOD_GRATE.get()
									...
									: -1) == 3) {
						{
							if (world instanceof ILevelExtension extension) {
								IFluidHandler fluidHandler = extension.getCapability(Capabilities.FluidHandler.BLOCK, BlockPos.containing(x, (y - 1), z), null);
								if (fluidHandler != null) {
									fluidHandler.fill(new FluidStack((new FluidStack(BuiltInRegistries.FLUID.get(ResourceLocation.parse("vampirism:impure_blood")), 1)).getFluid(), (int) 50), IFluidHandler.FluidAction.EXECUTE);
								}
							}
						}
					} else if ((world.getBlockState(BlockPos.containing(x, y - 2, z))).getBlock() == ButcheryModBlocks.BLOOD_GRATE.get()
