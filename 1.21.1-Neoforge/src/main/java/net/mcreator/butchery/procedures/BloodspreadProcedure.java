...
public class BloodspreadProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (ButcheryconfigConfiguration.BLOOD_SPREAD.get() == true) {
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == ButcheryModBlocks.BLOOD_PUDDLE.get() && getBlockNBTLogic(world, BlockPos.containing(x, y, z), "sourceBlood") == true) {
				ButcheryMod.queueServerWork(4, () -> {
					if ((world.getBlockState(BlockPos.containing(x + 1, y, z))).getBlock() == Blocks.AIR && (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == ButcheryModBlocks.BLOOD_PUDDLE.get()
							&& getBlockNBTLogic(world, BlockPos.containing(x, y, z), "sourceBlood") == true) {
				...
				ButcheryMod.queueServerWork(12, () -> {
					if ((world.getBlockState(BlockPos.containing(x, y, z - 1))).getBlock() == Blocks.AIR && (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == ButcheryModBlocks.BLOOD_PUDDLE.get()
							&& getBlockNBTLogic(world, BlockPos.containing(x, y, z), "sourceBlood") == true) {
				...
				ButcheryMod.queueServerWork(20, () -> {
					if ((world.getBlockState(BlockPos.containing(x + 1, y, z + 1))).getBlock() == Blocks.AIR && (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == ButcheryModBlocks.BLOOD_PUDDLE.get()
							&& getBlockNBTLogic(world, BlockPos.containing(x, y, z), "sourceBlood") == true) {
				...
				ButcheryMod.queueServerWork(36, () -> {
					if ((world.getBlockState(BlockPos.containing(x + 2, y, z))).getBlock() == Blocks.AIR && (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == ButcheryModBlocks.BLOOD_PUDDLE.get()
							&& getBlockNBTLogic(world, BlockPos.containing(x, y, z), "sourceBlood") == true) {
				...
				ButcheryMod.queueServerWork(44, () -> {
					if ((world.getBlockState(BlockPos.containing(x, y, z - 2))).getBlock() == Blocks.AIR && (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == ButcheryModBlocks.BLOOD_PUDDLE.get()
							&& getBlockNBTLogic(world, BlockPos.containing(x, y, z), "sourceBlood") == true) {
				...
				ButcheryMod.queueServerWork(52, () -> {
					if ((world.getBlockState(BlockPos.containing(x + 2, y, z + 1))).getBlock() == Blocks.AIR && (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == ButcheryModBlocks.BLOOD_PUDDLE.get()
							&& getBlockNBTLogic(world, BlockPos.containing(x, y, z), "sourceBlood") == true) {
				...
				ButcheryMod.queueServerWork(60, () -> {
					if ((world.getBlockState(BlockPos.containing(x + 1, y, z - 2))).getBlock() == Blocks.AIR && (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == ButcheryModBlocks.BLOOD_PUDDLE.get()
							&& getBlockNBTLogic(world, BlockPos.containing(x, y, z), "sourceBlood") == true) {
				...
				ButcheryMod.queueServerWork(84, () -> {
					if ((world.getBlockState(BlockPos.containing(x - 2, y, z - 2))).getBlock() == Blocks.AIR && (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == ButcheryModBlocks.BLOOD_PUDDLE.get()
							&& getBlockNBTLogic(world, BlockPos.containing(x, y, z), "sourceBlood") == true) {
