...
public class MeatgrinderjeiRecipe implements Recipe<RecipeInput> {
	private final ItemStack output;
	private final NonNullList<Ingredient> recipeItems;

	public MeatgrinderjeiRecipe(ItemStack output, NonNullList<Ingredient> recipeItems) {
		this.output = output;
	...
	public static class Serializer implements RecipeSerializer<MeatgrinderjeiRecipe> {
		...
		private static final MapCodec<MeatgrinderjeiRecipe> CODEC = RecordCodecBuilder
				...
				}, DataResult::success).forGetter(recipe -> recipe.recipeItems)).apply(builder, MeatgrinderjeiRecipe::new));
