...
public class PestleandmortarrecipetypeRecipe implements Recipe<RecipeInput> {
	private final ItemStack output;
	private final NonNullList<Ingredient> recipeItems;

	public PestleandmortarrecipetypeRecipe(ItemStack output, NonNullList<Ingredient> recipeItems) {
		this.output = output;
	...
	public static class Serializer implements RecipeSerializer<PestleandmortarrecipetypeRecipe> {
		...
		private static final MapCodec<PestleandmortarrecipetypeRecipe> CODEC = RecordCodecBuilder
				...
				}, DataResult::success).forGetter(recipe -> recipe.recipeItems)).apply(builder, PestleandmortarrecipetypeRecipe::new));
