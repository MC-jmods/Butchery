...
public class Enderdragoncut3Renderer implements BlockEntityRenderer<Enderdragoncut3BlockEntity> {
	...
	@Override
	public void render(Enderdragoncut3BlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource renderer, int light, int overlayLight) {
		poseStack.pushPose();
	...
	private static final class CustomHierarchicalModel extends Modelender_dragon_cut_3 {
		...
		public void setupBlockEntityAnim(Enderdragoncut3BlockEntity blockEntity, float ageInTicks) {
