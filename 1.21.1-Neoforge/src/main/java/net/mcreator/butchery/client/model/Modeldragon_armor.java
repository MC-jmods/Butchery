...
public class Modeldragon_armor<T extends Entity> extends EntityModel<T> {
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int rgb) {
		...
		LeftPlate.render(poseStack, vertexConsumer, packedLight, packedOverlay, rgb);
		RightPlate.render(poseStack, vertexConsumer, packedLight, packedOverlay, rgb);
		LeftLegging.render(poseStack, vertexConsumer, packedLight, packedOverlay, rgb);
		RightLegging.render(poseStack, vertexConsumer, packedLight, packedOverlay, rgb);
