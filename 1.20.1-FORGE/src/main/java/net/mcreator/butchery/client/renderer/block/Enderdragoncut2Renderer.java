...
public class Enderdragoncut2Renderer implements BlockEntityRenderer<Enderdragoncut2BlockEntity> {
	...
	@Override
	public void render(Enderdragoncut2BlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource renderer, int light, int overlayLight) {
		poseStack.pushPose();
	...
	private static final class CustomHierarchicalModel extends Modelender_dragon_cut_2 {
		...
		public void setupBlockEntityAnim(Enderdragoncut2BlockEntity blockEntity, float ageInTicks) {
