...
public class SniffercarcassblockRenderer implements BlockEntityRenderer<SniffercarcassblockBlockEntity> {
	...
	private void updateRenderState(SniffercarcassblockBlockEntity blockEntity) {
	...
	@Override
	public void render(SniffercarcassblockBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource renderer, int light, int overlayLight) {
	...
	private static final class CustomHierarchicalModel extends Modelsniffer_carcass {
		...
		public void setupBlockEntityAnim(SniffercarcassblockBlockEntity blockEntity, float ageInTicks) {
		...
		private class BlockEntityHierarchicalModel extends HierarchicalModel<Entity> {
			...
			public void setupBlockEntityAnim(SniffercarcassblockBlockEntity blockEntity, float ageInTicks) {
				...
				animator.animate(blockEntity.animationState0, hanging_sniffer_anim_idleAnimation.idle, ageInTicks, 1f);
			}
		}
	}
}