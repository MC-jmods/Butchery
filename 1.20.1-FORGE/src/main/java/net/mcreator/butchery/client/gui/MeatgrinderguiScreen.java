...
public class MeatgrinderguiScreen extends AbstractContainerScreen<MeatgrinderguiMenu> implements ButcheryModScreens.ScreenAccessor {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiGraphics.blit(ResourceLocation.parse("butchery:textures/screens/meat_grinder_gui.png"), this.leftPos + 0, this.topPos + 0, 0, 0, 256, 256, 256, 256);
		if (Meatgrinderprogressdisplay0Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("butchery:textures/screens/meat_grinder_0.png"), this.leftPos + 67, this.topPos + 42, 0, 0, 37, 27, 37, 27);
		}
		if (Meatgrinderprogressdisplay1Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("butchery:textures/screens/meat_grinder_1.png"), this.leftPos + 67, this.topPos + 42, 0, 0, 37, 27, 37, 27);
		}
		if (Meatgrinderprogressdisplay2Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("butchery:textures/screens/meat_grinder_2.png"), this.leftPos + 67, this.topPos + 42, 0, 0, 37, 27, 37, 27);
		}
		if (Meatgrinderprogressdisplay3Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("butchery:textures/screens/meat_grinder_3.png"), this.leftPos + 67, this.topPos + 42, 0, 0, 37, 27, 37, 27);
		}
		if (Meatgrinderprogressdisplay4Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("butchery:textures/screens/meat_grinder_4.png"), this.leftPos + 67, this.topPos + 42, 0, 0, 37, 27, 37, 27);
		}
		if (Meatgrinderprogressdisplay5Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("butchery:textures/screens/meat_grinder_5.png"), this.leftPos + 67, this.topPos + 42, 0, 0, 37, 27, 37, 27);
		}
		if (Meatgrinderprogressdisplay6Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("butchery:textures/screens/meat_grinder_6.png"), this.leftPos + 67, this.topPos + 42, 0, 0, 37, 27, 37, 27);
		}
		if (Meatgrinderprogressdisplay7Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("butchery:textures/screens/meat_grinder_7.png"), this.leftPos + 67, this.topPos + 42, 0, 0, 37, 27, 37, 27);
		}
		if (Meatgrinderprogressdisplay8Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("butchery:textures/screens/meat_grinder_8.png"), this.leftPos + 67, this.topPos + 42, 0, 0, 37, 27, 37, 27);
		}
		if (Meatgrinderprogressdisplay9Procedure.execute(world, x, y, z)) {
			guiGraphics.blit(ResourceLocation.parse("butchery:textures/screens/meat_grinder_9.png"), this.leftPos + 67, this.topPos + 42, 0, 0, 37, 27, 37, 27);
		}
