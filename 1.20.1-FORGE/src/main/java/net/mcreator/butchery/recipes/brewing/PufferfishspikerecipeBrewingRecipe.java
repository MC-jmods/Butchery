...
public class PufferfishspikerecipeBrewingRecipe implements IBrewingRecipe {
	...
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> BrewingRecipeRegistry.addRecipe(new PufferfishspikerecipeBrewingRecipe()));
	}
	...
	public boolean isIngredient(ItemStack ingredient) {
		return Ingredient.of(new ItemStack(ButcheryModItems.PUFFERFISH_SPIKE.get())).test(ingredient);
	}
