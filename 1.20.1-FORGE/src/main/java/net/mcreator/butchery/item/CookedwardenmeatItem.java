...
public class CookedwardenmeatItem extends Item {
	public CookedwardenmeatItem() {
		super(new Item.Properties().stacksTo(64).rarity(Rarity.COMMON).food((new FoodProperties.Builder()).nutrition(19).saturationMod(0.35f).meat().build()));
	}
