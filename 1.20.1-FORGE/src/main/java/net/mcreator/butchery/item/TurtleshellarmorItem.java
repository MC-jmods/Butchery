...
public abstract class TurtleshellarmorItem extends ArmorItem {
	public TurtleshellarmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(ButcheryModItems.TURTLE_SHELL_FRAGMENT.get()));
			}

			@Override
			public String getName() {
				return "turtle_shell_armor";
			}
	...
	public static class Chestplate extends TurtleshellarmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "butchery:textures/entities/turtle_armor.png";
		}
	}
	...
	public static class Leggings extends TurtleshellarmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "butchery:textures/models/armor/turtle_shell_armor_layer_2.png";
		}
	}
	...
	public static class Boots extends TurtleshellarmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "butchery:textures/models/armor/turtle_shell_armor_layer_1.png";
		}
	}
}