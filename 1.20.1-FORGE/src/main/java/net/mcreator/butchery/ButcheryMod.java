...
import net.mcreator.butchery.init.ButcheryModPaintings;
...
public class ButcheryMod {
	...
	public ButcheryMod(FMLJavaModLoadingContext context) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = context.getModEventBus();
		ButcheryModSounds.REGISTRY.register(bus);
		ButcheryModBlocks.REGISTRY.register(bus);
		ButcheryModBlockEntities.REGISTRY.register(bus);
		ButcheryModItems.REGISTRY.register(bus);
		ButcheryModEntities.REGISTRY.register(bus);
		ButcheryModEnchantments.REGISTRY.register(bus);
		ButcheryModTabs.REGISTRY.register(bus);
		ButcheryModFeatures.REGISTRY.register(bus);

		ButcheryModMobEffects.REGISTRY.register(bus);

		ButcheryModPaintings.REGISTRY.register(bus);
		ButcheryModParticleTypes.REGISTRY.register(bus);

		ButcheryModMenus.REGISTRY.register(bus);
		ButcheryModFluids.REGISTRY.register(bus);
		ButcheryModFluidTypes.REGISTRY.register(bus);
