	...
	private static void execute(@Nullable Event event, Entity entity, ItemStack itemstack) {
		...
		if (itemstack.getItem() == ButcheryModItems.BONE_SKINNING_KNIFE.get() || itemstack.getItem() == ButcheryModItems.IRON_SKINNING_KNIFE.get() || itemstack.getItem() == ButcheryModItems.GOLD_SKINNING_KNIFE.get()
			...
			if ((entity instanceof ServerPlayer _plr10 && _plr10.level() instanceof ServerLevel
					&& _plr10.getAdvancements().getOrStartProgress(_plr10.server.getAdvancements().getAdvancement(ResourceLocation.parse("butchery:cut_abovethe_rest"))).isDone()) == true) {
				if ((entity instanceof ServerPlayer _plr11 && _plr11.level() instanceof ServerLevel
						&& _plr11.getAdvancements().getOrStartProgress(_plr11.server.getAdvancements().getAdvancement(ResourceLocation.parse("butchery:knifeto_meet_you"))).isDone()) == false) {
					if (entity instanceof ServerPlayer _player) {
						Advancement _adv = _player.server.getAdvancements().getAdvancement(ResourceLocation.parse("butchery:knifeto_meet_you"));
